...
extends TickTask {
    ...
    public final void execute() {
        ...
        if (this.objectId == 2519 && this.player.getQuestManager().handleSecondObjectAction(this.objectId, this.objectX, this.objectY)) {
            this.stop();
            return;
        }
        ...
        if (LumbridgeCastleCellarHandler.handleSecondObjectAction(this.player, this.objectId, this.objectX, this.objectY, this.objectPlane)) {
            this.stop();
            return;
        }
